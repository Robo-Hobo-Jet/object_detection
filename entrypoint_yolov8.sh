...
ros2 run image_transport republish raw compressed --ros-args --remap in:=/yolov8_processed_image --remap /out/compressed:=/yolov8_processed_image/compressed -p compressed.jpeg_quality:=80
